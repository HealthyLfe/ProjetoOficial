...
import kotlinx.android.synthetic.main.fragment_receitas_almoco.view.*

/**
 * A simple [Fragment] subclass.
 */
class ReceitasAlmocoFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view: View = inflater.inflate(R.layout.fragment_receitas_almoco, container, false)
    ...
    private fun preencherRecyclerView(view: View) {
        ...
        var recyclerView = view.recyclerViewListaAlmocoUser
